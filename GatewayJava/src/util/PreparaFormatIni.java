...
public class PreparaFormatIni {
	...
	public PreparaFormatIni(String maskName) {
		if(maskName.contains("SIE_CT_MIS")) {
			tipoFichero="SIE";
			this.PreparaPduSIE(maskName);
		}else {
			tipoFichero="NOSIE";
			this.PreparaDefNoSIE(maskName);
		}
	}
	
	private void PreparaPduSIE(String maskName) {
		//(Pendiente)
	}
...
////     N O   S  I  E
////////////////////////////////////////////////
	private void PreparaDefNoSIE(String maskName) {
	  String Centro = null;
	  ...
	  String GroupBy = null;
	  String Idioma = null;
	  String tipoFormatoFichero=null;
...
///////////////////////////////////////////////		  		
    	 ...
    	 // Asignar Maquinas MachineId
		  ...
		  //Asignar Shift
		  		String shift = definicionesIni.getKeySeccion("Shift", Turno);
    ...
    public static void main(String[] args){
       ...
       PreparaFormatIni pdu= new PreparaFormatIni(args[0]);
